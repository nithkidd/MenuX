    ...
    >
      <div className="flex items-center gap-3 overflow-hidden">
        ...
        <div className="flex flex-col truncate">
          <span
            className={`font-semibold truncate ${isSelected ? "text-orange-900 dark:text-orange-100" : "text-stone-700 dark:text-stone-300"}`}
          >
            {category.name}
          </span>
          <span
            className={`text-xs ${isSelected ? "text-orange-500 dark:text-orange-400" : "text-stone-400 dark:text-stone-500"}`}
          >
