...
import { businessCreateTourSteps } from "../../../shared/config/tours";
...
export default function CreateBusiness() {
  ...
  // Start business creation tour for first-time users
  useEffect(() => {
    if (
      isTourCompleted("dashboard-first-visit") &&
      !isTourCompleted("business-create")
    ) {
      setTimeout(() => {
        startTour("business-create", businessCreateTourSteps);
      }, 500);
    }
            ...
            <div className="bg-white dark:bg-stone-900 py-8 px-4 shadow-sm sm:rounded-3xl sm:px-10 border border-stone-200 dark:border-stone-800">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  ...
                  <div className="mt-1" data-tour="business-name-input">
                    <input
                      id="name"
                      name="name"
                      type="text"
                ...
                <div>
                  ...
                  <div className="mt-1" data-tour="business-type-select">
                    <select
                      id="type"
                      name="type"
                      value={type}
                ...
                <div>
                  ...
                  <div className="mt-1" data-tour="business-description">
                    <textarea
                      id="description"
                      name="description"
                      rows={3}
                ...
                {error && (
                  <div className="text-red-500 text-sm bg-red-50 dark:bg-red-900/10 p-2 rounded-lg text-center">
                    {error}
                  </div>
                )}

                <div data-tour="create-business-submit">
                  <button
                    type="submit"
                    disabled={loading}
                ...
                <div className="text-center">
                  <button
                    type="button"
                    onClick={() => navigate("/dashboard")}
                    className="text-stone-500 text-sm hover:text-orange-600 transition-colors btn-press"
                  >
                    Cancel
                  </button>
                </div>
